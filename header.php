...
<body <?php body_class(); ?>>
	<header class="header"role="banner">
		...
		<h1><a class="logo" title="justmarkup" href="<?php echo get_home_url(); ?>/"><svg width="120" height="90" xmlns="http://www.w3.org/2000/svg">
 <g>
  <g id="svg_1">
   <g>
