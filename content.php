...
<article class="article">
	...
	<?php endif; ?>
	<h3><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'justmarkup' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h3>
	...
	<?php else : ?>
		<?php the_content( __( 'Read more', 'justmarkup' ) ); ?>
